  ...
  if (navActionsContainer) {
    if (sessionData && sessionData.user) {
      ...
      navActionsContainer.innerHTML = `
        <a href="chats.html" class="flex w-10 h-10 items-center justify-center rounded-full bg-slate-100/80 hover:bg-indigo-50 text-slate-600 hover:text-[#5144d4] transition-all shadow-[0_2px_8px_rgba(26,28,31,0.03)] hover:shadow-indigo-500/10 relative group" title="Mis Mensajes">
